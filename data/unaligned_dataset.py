...
class UnalignedDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.C_paths = sorted(make_dataset(self.dir_C, opt.max_val_dataset_size, img_file = opt.trainC_images))    # load images from '/path/to/data/trainC'

        self.A_size = len(self.A_paths)  # get the size of dataset A
        self.B_size = len(self.B_paths)  # get the size of dataset B
        self.C_size = len(self.C_paths)  # get the size of dataset C

        self.external_val = zip([Image.open(C_path).convert('RGB') for C_path in self.C_paths], self.C_paths)
...
#        print('current_epoch', self.current_epoch)
        ...
        return {'A': A, 'B': B, 'A_paths': A_path, 'B_paths': B_path, 'val':self.external_val, "val_path":self.C_paths}
