...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--load_size_x', type=int, default=128, help='scale images to this size')
        parser.add_argument('--load_size_y', type=int, default=256, help='scale images to this size')
        parser.add_argument('--crop_size', type=int, default=256, help='then crop to this size')
        parser.add_argument('--max_dataset_size', type=int, default=float("inf"), help='Maximum number of samples allowed per dataset. If the dataset directory contains more than max_dataset_size, only a subset is loaded.')
        parser.add_argument('--max_val_dataset_size', type=int, default=10, help='Maximum number of samples allowed per dataset. If the dataset directory contains more than max_dataset_size, only a subset is loaded.')
        ...
        parser.add_argument('--realism_loss', action='store_true', help='Compute realsim loss')
        parser.add_argument('--grayscale', action='store_true', help='Set grayscale images')
